...
import { CreditCardIcon, Link01Icon as LinkIcon, Shield01Icon as ShieldCheckIcon, GlobeIcon as WebhookIcon } from "@hugeicons/core-free-icons"
...
*   **Dry-Run Testing**: Test your routing logic in [Sandbox Mode](/docs/reevit/test-mode) to see how the engine behaves before going live.
...
1.  **Capability Filter**: Only connections supporting the requested [Method and Country](/docs/reevit/connections) are considered.
...
3.  **Monitor Health**: Regularly check your [Connection Health scores](/docs/reevit/connections) to see if the engine is frequently failing over. This may indicate a needed change in your primary rules.
