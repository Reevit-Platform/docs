...
| Mode | Prefix | Intent |
| :--- | :--- | :--- |
| **Sandbox** | `pfk_test_...secret` | For development, QA, and automated testing. |
| **Production** | `pfk_live_...secret` | For real money transactions. Requires [KYC Approval](#path-to-production). |
...
4.  **Key Rotation**: Swap `pfk_test_...secret` for `pfk_live_...secret` in your production environment.
