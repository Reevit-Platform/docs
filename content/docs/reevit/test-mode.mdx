...
| Mode | Prefix | Intent |
| :--- | :--- | :--- |
| **Sandbox** | `pfk_test_...` | For development, QA, and automated testing. |
| **Production** | `pfk_live_...` | For real money transactions. Requires [KYC Approval](#path-to-production). |

```bash
# Example Sandbox Request
curl -X POST https://api.reevit.com/v1/payments/intents \
  -H "X-Reevit-Key: pfk_test_your_key" \
...
4.  **Key Rotation**: Swap `pfk_test_...` for `pfk_live_...` in your production environment.
