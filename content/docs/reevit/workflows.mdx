...
import { CreditCardIcon, Link01Icon as LinkIcon, GlobeIcon as WebhookIcon, RepeatIcon } from "@hugeicons/core-free-icons"
...
*   **Bring Your Own Key (BYOK)**: Connect your existing [Twilio, Resend, or SendGrid](/docs/reevit/connections) accounts. Use your own templates and maintain full control over your sender reputation.
...
1.  **Event Trigger**: A transaction moves to a new state (e.g., `payment.success`).
...
2.  **Set Up "Dead Letter" Webhooks**: Always have a [Standard Webhook](/docs/reevit/webhooks) for your core database updates. Use Workflows for the secondary "noisy" actions.
3.  **Validate in Sandbox**: Test your workflow logic with [Test API Keys](/docs/reevit/test-mode) to ensure your message templates look perfect before emailing real customers.
