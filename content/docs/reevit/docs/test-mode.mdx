...
*   **Safe Experimentation**: Try out new [Routing Rules](/docs/reevit/docs/routing-rules) or [Workflows](/docs/reevit/docs/workflows) with zero consequences if you make a configuration error.
...
2.  **Live Connections**: Replace your Sandbox PSP keys (e.g., Paystack Test) with Live keys in [Connections](/docs/reevit/docs/connections).
