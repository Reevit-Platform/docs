...
|----------|-------------------------------------------|
| Paystack | `https://api.reevit.io/webhooks/paystack` |
| Flutterwave | `https://api.reevit.io/webhooks/flutterwave` |
| Hubtel | `https://api.reevit.io/webhooks/hubtel` |
| M-Pesa | `https://api.reevit.io/webhooks/mpesa` |
| Stripe | `https://api.reevit.io/webhooks/stripe` |
